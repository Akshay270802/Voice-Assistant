...
speak("Loading your AI personal assistant. Please keep patience")
wishMe()
...
if __name__=='__main__':
    ...
    while True:
        ...
        if 'wikipedia' in statement:
            ...
            speak("I was built by Akshay Panchal")
            print("I was built by Akshay Panchal")
            ...
            client = wolframalpha.Client('6L4A7G-2GVWLLU7H8')
